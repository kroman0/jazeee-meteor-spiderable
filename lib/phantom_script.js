...
var renderPage = function (url) {
  ...
  var isReady = function () {
    return page.evaluate(function () {
      ...
      if (typeof Package === 'undefined' || Package['kroman0:spiderable-longer-timeout'] === undefined || Package['kroman0:spiderable-longer-timeout'].Spiderable === undefined || !Package['kroman0:spiderable-longer-timeout'].Spiderable._initialSubscriptionsStarted) {
        return false;
      }
