...
var renderPage = function (_url) {
  ...
  var isReady = function () {
    return page.evaluate(function () {
      ...
      if (typeof window.Package === 'undefined' || window.Package['kroman0:spiderable-longer-timeout'] === undefined || window.Package['kroman0:spiderable-longer-timeout'].Spiderable === undefined || !window.Package['kroman0:spiderable-longer-timeout'].Spiderable._initialSubscriptionsStarted) {
        return { ready: false };
      }
  ...
  var dumpPageContent = function () {
    ...
    /*
    @url https://github.com/kroman0/kroman0-meteor-spiderable/issues/16
